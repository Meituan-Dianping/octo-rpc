...
class EchoCobClIf {
 public:
  virtual ~EchoCobClIf() {}
  virtual void echo(std::tr1::function<void(EchoCobClient* client)> cob, const std::string& arg) = 0;
};

class EchoCobSvIf {
 public:
  virtual ~EchoCobSvIf() {}
  virtual void echo(std::tr1::function<void(std::string const& _return)> cob, const std::string& arg) = 0;
};
...
class EchoCobClient : virtual public EchoCobClIf {
 public:
  ...
  void echo(std::tr1::function<void(EchoCobClient* client)> cob, const std::string& arg);
  void send_echo(const std::string& arg);
  void recv_echo(std::string& _return);
 protected:
