...
public class MockUtil {
    ...
    public static Request getAynsRequest() throws Exception {
        DefaultRequest request = new DefaultRequest();
        request.setServiceImpl(HelloServiceImpl.class.newInstance());
        request.setData(getAsyncRpcInvocation());
        return request;
    }
    ...
    public static Request getRequest() {
        DefaultRequest request = new DefaultRequest();
        try {
            request.setServiceImpl(EchoImpl.class.newInstance());
            request.setData(getRpcInvocation());
            request.setOctoProtocol(true);
            request.setMessageType(MessageType.Normal.getValue());
            request.setSerialize((byte) 1);
            request.setServiceInterface(Echo.Iface.class);
            request.setSeq(1L);
            request.setTimeout(100);
            request.setServiceName("Echo.Iface");
            request.setCallType((byte) 1);
            request.setAppkey("com.meituan.octo.dorado.client");
    ...
    public static Request getErrorRequest() throws Exception {
        DefaultRequest request = new DefaultRequest();
        request.setServiceImpl(HelloServiceImpl.class.newInstance());
        request.setData(getErrorRpcException());
        return request;
    }

    public static Request getHeartBeatRequest() {
        DefaultRequest request = new DefaultRequest();
        request.setMessageType(MessageType.ScannerHeartbeat.getValue());
        return request;
    }
    ...
    public static ResponseFuture<Integer> getFuture() throws Exception {
