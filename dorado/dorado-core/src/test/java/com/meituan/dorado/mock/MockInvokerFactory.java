...
public class MockInvokerFactory implements InvokerFactory{

    @Override
    public Invoker buildInvoker(ClientConfig config, Provider provider) {
        return new MockInvoker(provider, config.getServiceInterface());
    }
}
