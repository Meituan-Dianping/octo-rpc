...
/**
 * 注意此方式需要在配置thrift/zkregistry/thrift-provider.xml中配置你的zk服务地址
 */
public class ThriftProvider {

    public static void main(String[] args) throws Exception {
        ClassPathXmlApplicationContext beanFactory = new ClassPathXmlApplicationContext("thrift/zkregistry/thrift-provider.xml");
