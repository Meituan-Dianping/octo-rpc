...
public class GenericCommonInvokeTest {
    ...
    public static void start() {
        serverBeanFactory = new ClassPathXmlApplicationContext("thrift/genericCommon/thrift-provider.xml");
        clientBeanFactory = new ClassPathXmlApplicationContext("thrift/genericCommon/thrift-consumer.xml");
