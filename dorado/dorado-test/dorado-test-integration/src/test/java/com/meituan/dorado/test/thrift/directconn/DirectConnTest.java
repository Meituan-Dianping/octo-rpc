...
package com.meituan.dorado.test.thrift.directconn;
...
public class DirectConnTest {
    ClassPathXmlApplicationContext clientBean;
    ClassPathXmlApplicationContext serverBean;

    @Before
    public void init() {
        serverBean = new ClassPathXmlApplicationContext("thrift/direconn/thrift-provider.xml");
        clientBean = new ClassPathXmlApplicationContext("thrift/direconn/thrift-consumer.xml");
    ...
    public void test() {
        ...
        try {
            ...
            String ret2 = octoProtocolClient.sayHello("Dorado");
