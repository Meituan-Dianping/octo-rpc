...
public class GenericSimpleInvokeTest {
    ...
    public static void start() {
        serverBeanFactory = new ClassPathXmlApplicationContext("thrift/genericSimple/thrift-provider.xml");
        clientBeanFactory = new ClassPathXmlApplicationContext("thrift/genericSimple/thrift-consumer.xml");
    ...
    public void testEcho3() {
        ...
        try {
            String expected = JacksonUtils.simpleSerializeUnchecked(subMessage);
    ...
    public void testEcho4() {
        ...
        try {
            String expected = JacksonUtils.simpleSerializeUnchecked(subMessages);
...
//
//        try {
//            String expected = JacksonUtils.simpleSerializeUnchecked(maps);
...
//    }
    ...
    public void testEcho6() {
        ...
        try {
            String expected = JacksonUtils.simpleSerializeUnchecked(message);
    ...
    public void testList() {
        ...
        try {
            ...
            String expected = JacksonUtils.simpleSerializeUnchecked(paramValues);
...
//    }
    ...
    @Test
    public void testParamTypesNull() {
        try {
            Set<String> paramValues = new HashSet<>();
            paramValues.add("first");
            paramValues.add("second");
            String expected = JacksonUtils.simpleSerializeUnchecked(paramValues);
            String result = clientForAnno.$invoke("testSet", null, new Object[]{paramValues});
            System.out.println(result);
            Assert.assertEquals(expected, result);
        } catch (Exception e) {
            Assert.fail(e.getMessage());
