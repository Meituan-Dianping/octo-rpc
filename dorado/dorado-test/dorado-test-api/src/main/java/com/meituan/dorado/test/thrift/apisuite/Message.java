...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  public Message(Message other) {
    ...
    if (other.isSetSubMessages()) {
      List<SubMessage> __this__subMessages = new ArrayList<SubMessage>(other.subMessages.size());
  ...
  public int hashCode() {
    ...
    boolean present_subMessages = true && (isSetSubMessages());
    list.add(present_subMessages);
    if (present_subMessages)
      list.add(subMessages);
  ...
  public int compareTo(Message other) {
    ...
    lastComparison = Boolean.valueOf(isSetSubMessages()).compareTo(other.isSetSubMessages());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubMessages()) {
